...
export default function Settings() {
  ...
  {
    for (let i = 1; i < 6; i++) {
      if(user.avatar == `/avatars/${i}.png`) {
        imgs.push(
          <span className="checked_img">
            <img className="imgavt active" src={`/avatars/${i}.png`}/>
        ...
        imgs.push(
            <img className="imgavt" src={`/avatars/${i}.png`} onClick={()=>handleImageClick(`/avatars/${i}.png`)}/>
        )
      }
    }
  }

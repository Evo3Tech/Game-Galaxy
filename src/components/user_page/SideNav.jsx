        ...
        <div className="sideNav">
            <div className="logo_search">
                ...
                <button className="search_btn" style={search_style_obj} >
                    ...
                    <img src={search_svg} onClick={handleSearchBox}/>

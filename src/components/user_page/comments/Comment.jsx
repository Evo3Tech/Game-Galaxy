...
export default function Comment({comment}) {
    ...
    async function add_like() {
        const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/user/add_like`, {
            method: "POST",
            headers: {
    ...
    async function send_friend_request() {
        const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/user/friends/request`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
            body: JSON.stringify(
                {
                    ...
                    user_s_name: user_info.name,
                    user_r_id: comment.user_id,
                }
            )
        })
                ...
                <div className="comment_cont">
                    ...
                    <div className="comment_content">
                        <h5 className='username_comment'>
                            {comment.writer}
                            <span style={add_friend_styles} className="add_friend_btn" onClick={send_friend_request}>
